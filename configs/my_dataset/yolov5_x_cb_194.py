_base_ = r'D:\mmyolo-jmax\configs\yolov5\yolov5_x-v61_syncbn_fast_8xb16-300e_coco.py'

max_epochs = 2000  # 训练的最大 epoch
data_root = 'D:\\datasets\\cb_detc_test\\'  # 数据集目录的绝对路径
# data_root = '/root/workspace/mmyolo/data/cat/'  # Docker 容器里面数据集目录的绝对路径

# 结果保存的路径，可以省略，省略保存的文件名位于 work_dirs 下 config 同名的文件夹中
# 如果某个 config 只是修改了部分参数，修改这个变量就可以将新的训练文件保存到其他地方
work_dir = './work_dirs/yolov5_x_test'
...
#load_from = 'D:\mmyolo-jmax\configs\my_dataset\yolov5_m-v61_syncbn_fast_8xb16-300e_coco_20220917_204944-516a710f.pth'  # noqa
